                ...
                <div class="col-md-7 mt-3">
                    <div class="product-view">
                        ...
                        <div>
                            ...
                            {{-- <input type="radio" name="colorSeletion" value="{{ $colorItem->id }}" />{{
                            $colorItem->color->name }} --}}
                            <label class="colorSelectionLabel" style="background-color: {{ $colorItem->color->name }}"
                                wire:click="colorSeleted({{ $colorItem->id }})">
                                {{ $colorItem->color->name }}
                            </label>
                            @endforeach
                            @endif
                        ...
                        <div class="mt-2">
                            ...
                            <button type="button" wire:click="addToWhishList({{ $product->id }})" class="btn btn1">
                                ...
                                <span wire:loading wire:target="addToWhishList">
